...
## Active Technologies
- JavaScript (ES2022+), React 18, Node.js 20+ tooling + React, Vite, Tailwind CSS, Browser Geolocation API, Open-Meteo weather and geocoding services (003-initial-geolocation-source)
- Browser `sessionStorage` for existing recent-search and UI session state; no database (003-initial-geolocation-source)
...
## Recent Changes
- 003-initial-geolocation-source: Added JavaScript (ES2022+), React 18, Node.js 20+ tooling + React, Vite, Tailwind CSS, Browser Geolocation API, Open-Meteo weather and geocoding services
